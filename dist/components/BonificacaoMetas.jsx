...
export default function BonificacaoMetas({ barbeiroId, barbeiroNome, mes, ano, unidade, comissaoBase }) {
    ...
    return (<Card className="mb-4">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg flex items-center justify-between">
          ...
          {metaBatida && (<Badge className="bg-green-100 text-green-800">
      ...
      <CardContent>
        ...
        {bonificacao > 0 && (<div className="mt-3 p-3 bg-green-50 rounded-lg">
