    ...
    return (<Card>
      <CardBody>
        <div className="flex justify-between items-center mb-6">
          ...
          <Select selectedKeys={[selectedYear.toString()]} onChange={(e) => setSelectedYear(Number(e.target.value))} className="w-32">
        ...
        <div className="h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data}>
              ...
              <XAxis dataKey="month" tickFormatter={formatMonth} tick={{ fill: 'currentColor' }}/>
              ...
              <Legend />
              <Line type="monotone" dataKey="revenue" name="Faturamento" stroke="#10B981" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }}/>
              <Line type="monotone" dataKey="goal" name="Meta" stroke="#6366F1" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }}/>
            </LineChart>
          </ResponsiveContainer>
        </div>
      </CardBody>
