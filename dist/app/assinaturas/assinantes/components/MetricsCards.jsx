...
export default function MetricsCards() {
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <Button color="primary" variant="light" startContent={<ArrowPathIcon className="w-4 h-4"/>} onClick={refreshData} isLoading={loading}>
          Atualizar Dados
        </Button>
      </div>
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                {metrics.asaasTrato.total && (<p className="text-blue-200 text-xs mt-1">
                    Total confirmados: {metrics.asaasTrato.total}
                  </p>)}
                {metrics.asaasTrato.error && (<Chip size="sm" color="danger" variant="flat" className="mt-2">
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                {metrics.asaasAndrey.total && (<p className="text-green-200 text-xs mt-1">
                    Total confirmados: {metrics.asaasAndrey.total}
                  </p>)}
                {metrics.asaasAndrey.error && (<Chip size="sm" color="danger" variant="flat" className="mt-2">
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                {metrics.external.total && (<p className="text-purple-200 text-xs mt-1">
                    Total registrados: {metrics.external.total}
                  </p>)}
                {metrics.external.error && (<Chip size="sm" color="danger" variant="flat" className="mt-2">
