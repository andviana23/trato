...
export default function AgendamentosPage() {
    ...
    const agendamentosFormatados = useMemo(() => {
        return agendamentos.map((agendamento) => (Object.assign(Object.assign({}, agendamento), { dataFormatada: new Date(agendamento.data).toLocaleDateString('pt-BR', { day: '2-digit', month: '2-digit' }) })));
    }, [agendamentos]);
      ...
      <Card>
        ...
        <CardBody>
          <div className="space-y-4">
            {agendamentosFormatados.map((agendamento) => (<div key={agendamento.id} className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Chip color={getStatusColor(agendamento.status)} variant="flat" size="sm">
