...
export default function DashboardPage() {
    ...
    const dataCadastro = useMemo(() => {
        if (!(user === null || user === void 0 ? void 0 : user.created_at))
            return '';
    ...
    const ultimoAcesso = useMemo(() => {
        if (!(user === null || user === void 0 ? void 0 : user.last_sign_in_at) && !(user === null || user === void 0 ? void 0 : user.created_at))
            return '';
        return new Date(user.last_sign_in_at || user.created_at).toLocaleDateString('pt-BR');
    }, [user === null || user === void 0 ? void 0 : user.last_sign_in_at, user === null || user === void 0 ? void 0 : user.created_at]);
    if (loading) {
    ...
    return (<>
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
          Bem-vindo, {(profile === null || profile === void 0 ? void 0 : profile.name) || 'Usuário'}!
        </h1>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900 dark:text-white">
                  {(profile === null || profile === void 0 ? void 0 : profile.name) || 'Não informado'}
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                <p className="text-gray-900 dark:text-white">
                  {(profile === null || profile === void 0 ? void 0 : profile.phone) || 'Não informado'}
                </p>
              </div>
            </div>
            <div className="space-y-4">
              <div>
                ...
                <Chip color={getRoleColor((profile === null || profile === void 0 ? void 0 : profile.role) || 'client')} variant="flat">
                  {getRoleLabel((profile === null || profile === void 0 ? void 0 : profile.role) || 'client')}
                </Chip>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
