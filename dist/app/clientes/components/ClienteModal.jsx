...
export default function ClienteModal({ open, onClose, onSuccess, cliente }) {
    ...
    async function onSubmit(data) {
        try {
            ...
            if (data.data_nascimento && data.data_nascimento.length === 10)
    ...
    return (<Modal isOpen={open} onOpenChange={onClose} placement="center" size="lg">
      <ModalContent>
