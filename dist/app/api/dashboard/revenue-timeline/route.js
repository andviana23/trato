...
export async function GET(request) {
    try {
        ...
        const yearlyTotals = {
            ...
            bestMonth: monthlyTimeline.reduce((best, current) => current.revenue > best.revenue ? current : best),
            worstMonth: monthlyTimeline.reduce((worst, current) => current.revenue < worst.revenue ? current : worst)
        };
