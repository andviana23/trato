...
export const useBarberQueue = () => {
    ...
    const fetchProfessionals = async () => {
        ...
        `)
            ...
            const barbeirosNaFila = filaData.filter(item => { var _a; return ((_a = item.profissionais) === null || _a === void 0 ? void 0 : _a.funcao) === 'barbeiro'; });
            ...
            const processedData = barbeirosNaFila.map(item => {
                ...
                return ({
                    ...
                    barber: {
                        id: (_a = item.profissionais) === null || _a === void 0 ? void 0 : _a.id,
                        nome: ((_b = item.profissionais) === null || _b === void 0 ? void 0 : _b.nome) || 'Nome não informado',
                        telefone: ((_c = item.profissionais) === null || _c === void 0 ? void 0 : _c.telefone) || 'Telefone não informado',
                        email: (_d = item.profissionais) === null || _d === void 0 ? void 0 : _d.email,
                        avatar_url: ((_e = item.profissionais) === null || _e === void 0 ? void 0 : _e.avatar_url) || DEFAULT_AVATAR
                    }
                });
            });
    ...
    const reorganizarFila = async () => {
        ...
        `)
            ...
            console.log('[BarberQueue] Nova ordem:', novaOrdem.map(b => {
                var _a;
                return ({
                    nome: (_a = b.profissionais) === null || _a === void 0 ? void 0 : _a.nome,
    ...
    // 1. Botão "+1" (Atendeu)
    const handleAtendimento = async (professionalId) => {
        ...
        try {
            ...
            const { error } = await supabase
                .from('barber_queue')
                .update({
                daily_services: ((currentData === null || currentData === void 0 ? void 0 : currentData.daily_services) || 0) + 1,
                total_services: ((currentData === null || currentData === void 0 ? void 0 : currentData.total_services) || 0) + 1,
    ...
    const handlePassarVez = async (professionalId) => {
        ...
        try {
            ...
            const { error } = await supabase
                ...
                daily_services: ((currentData === null || currentData === void 0 ? void 0 : currentData.daily_services) || 0) + 1,
                total_services: ((currentData === null || currentData === void 0 ? void 0 : currentData.total_services) || 0) + 1,
                passou_vez: ((currentData === null || currentData === void 0 ? void 0 : currentData.passou_vez) || 0) + 1
            })
                .eq('profissional_id', professionalId);
            if (error)
                throw error;
    ...
    const handleToggleAtivo = async (professionalId, novoStatus) => {
    ...
    const moveBarberPosition = async (professionalId, newPosition) => {
