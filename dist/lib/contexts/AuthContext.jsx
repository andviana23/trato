...
export const AuthProvider = ({ children }) => {
    ...
    const fetchProfile = async (userId) => {
        try {
            ...
            console.log('[Auth] Dados do user_metadata:', user === null || user === void 0 ? void 0 : user.user_metadata);
            if (user === null || user === void 0 ? void 0 : user.user_metadata) {
                return {
                    id: userId,
                    email: user.email || '',
    ...
    const updateProfile = async (data) => {
        ...
        try {
            ...
            if (profile) {
                const updatedProfile = Object.assign(Object.assign({}, profile), data);
...
export const usePermissions = () => {
    ...
    const role = (_a = profile.role) === null || _a === void 0 ? void 0 : _a.toLowerCase();
