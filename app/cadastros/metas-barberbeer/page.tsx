          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="mb-4">
                ...
                <Input
                  type="number"
                  min={0}
                  value={form.quantidade_produtos || 0}
                  onChange={e => setForm({ ...form, quantidade_produtos: parseInt(e.target.value) || 0 })}
                  placeholder="0"
                />
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: 'fixo' | 'percentual') => setForm({ ...form, tipo_bonificacao: value })}
                >
                  <Select.Trigger>
                    <Select.Value />
                  </Select.Trigger>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setForm({ ...form, valor_bonificacao: parseFloat(e.target.value) || 0 })}
                  placeholder={form.tipo_bonificacao === 'fixo' ? '0,00' : '0'}
                />
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="max-h-48 overflow-y-auto">
                <table className="min-w-full text-sm">
                  ...
                  <tbody>
                    {metas
                      ...
                      .map(meta => (
                        <tr key={meta.id} className="border-b">
                          <td className="p-1">{barbeiros.find(b => b.id === meta.barbeiro_id)?.nome || meta.barbeiro_nome || '-'}</td>
                ...
                {metas.filter(meta => !form.barbeiro_id || meta.barbeiro_id === form.barbeiro_id).length === 0 && (
                  <div className="text-gray-500 text-center py-2">Nenhuma meta cadastrada.</div>
                )}
              </div>
            </div>
