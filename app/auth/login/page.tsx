    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <Input
          ...
          className="focus:ring-2 focus:ring-orange-400 bg-gray-50"
          autoFocus
        />
      </div>
      <div>
        ...
        <Input
          ...
          endContent={
            <button
              ...
              className="focus:outline-none text-gray-500 hover:text-orange-500 transition"
              tabIndex={-1}
      ...
      <Button
        type="submit"
        color="primary"
        className="w-full py-3 text-base font-bold rounded-xl shadow-md bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 transition"
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-blue-50 px-2 animate-fade-in">
