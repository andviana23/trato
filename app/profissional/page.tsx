...
import { Avatar, Button, Card, CardBody, CardHeader, CircularProgress, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Progress, Divider } from "@/components/ui/chakra-adapters";
  ...
  return (
    <div className="min-h-screen max-w-md mx-auto bg-gradient-to-b from-[#0b1420] to-[#0a0f18] text-white pb-24">
      ...
      <div className="px-4 mt-5 grid grid-cols-2 gap-4">
        {/* Minha Vez */}
        <Card.Root className="bg-[#0f1c2b] border border-white/5 col-span-2">
          <Card.Header className="pb-0"><div className="text-sm text-gray-300">Minha Vez</div></Card.Header>
          <Card.Body>
        ...
        <Card.Root className="bg-[#0f1c2b] border border-white/5">
          ...
          <Card.Body><div className="text-3xl font-extrabold text-blue-200 whitespace-nowrap">{formatarMoeda(assinaturaCommissionBRL)}</div></Card.Body>
        </Card.Root>
        ...
        <Card.Root className="bg-[#0f1c2b] border border-white/5">
          ...
          <Card.Body><div className="text-3xl font-extrabold text-blue-200 whitespace-nowrap">{formatarMoeda(avulsaCommissionBRL)}</div></Card.Body>
        </Card.Root>
        ...
        <Card.Root className="bg-[#0f1c2b] border border-white/5">
          ...
          <Card.Body><div className="text-3xl font-extrabold text-blue-200 whitespace-nowrap">{formatarMoeda(produtoCommissionBRL)}</div></Card.Body>
        </Card.Root>

        <Card.Root className="bg-[#0f1c2b] border border-white/5">
          <Card.Header className="pb-0"><div className="text-sm text-gray-300">Metas de Produto</div></Card.Header>
